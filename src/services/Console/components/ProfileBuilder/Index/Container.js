...
import { _set_state, loadProfileTemplate, updateProfileTemplate } from "../../../middleware/profileBuilder"

function Container(props) {
  const { employeeID, setState, state, _load_profile_template, _update_profile_template } = props
