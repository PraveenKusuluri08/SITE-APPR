...
function Presentation(props) {
  ...
  const formBTemplate = state.formBTemplate
  ...
  return (
    <div>
        ...
        <Grid container spacing={1}>
           ...
           {
            Object.values(formBTemplate.data.sections).sort((a, b) => a.sortPriority - b.sortPriority).map(section => {
            ...
            <div className="text-center d-flex justify-content-between w-100" >
              ...
              <div className="d-flex" style={{display:"flex",marginLeft:"600px"}} >
                ...
                <Button
                  ...
                  color="secondary"
                  onClick={onSave}
                  disabled={state.formBTemplate.isUpdating}
                >
                  Save Changes
                </Button>
              </div>
