        ...
        <div className="p-2" >
          <form onSubmit={onAddSection} >
            <TextField
              ...
              fullWidth
              required
              // helperText={Object.keys(state.formBTemplate.data.sections).includes(sectionName) ? "Already a section exists" : ""}
              value={sectionName}
            ...
            <div className="text-center w-100" >
              <Button
                // disabled={Object.keys(state.formBTemplate.data.sections).includes(sectionName)}
                variant="contained"
                size="small"
                color="primary"
                type="submit"
